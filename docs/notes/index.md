...
| Deep Learning | 用图解、PyTorch 代码和张量形状表串起神经网络、反向传播、Transformer 与注意力机制。 |
...
如果想先补深度学习基础，可以从 [Deep Learning 专题导读](deep-learning/index.md) 开始，按五章顺序读到 Transformer 和注意力机制。
...
| 从神经网络一路读到 Transformer | [Deep Learning 专题导读](deep-learning/index.md) |
